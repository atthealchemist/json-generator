...
var Commands = /** @class */ (function () {
    ...
    Commands.prototype.dateTime = function (format) {
        if (format) {
            return moment_1["default"](new Date(2018, 0, 1)).format(format);
        }
        return moment_1["default"](new Date(2018, 0, 1)).format("YYYY-MM-DD HH:mm:ss");
    };
    Commands.prototype.domainZone = function () {
        var domains = [];
        zones_json_1["default"].forEach(function (element) {
